...
public class ASMCodeFragment {
    ...
    public enum CodeType {
        GENERATES_VOID, GENERATES_VALUE, GENERATES_ADDRESS;
    }
    ...
    /**
     * Append all instructions in the argument to this code fragment. This does not
     * change the type of this code fragment; you must call markAsXXX afterwards if
