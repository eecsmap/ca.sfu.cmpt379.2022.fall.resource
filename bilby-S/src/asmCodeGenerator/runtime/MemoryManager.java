...
public class MemoryManager {
    // Debug Mode. DEBUGGING Adds debug code and executes insertDebugMain when the
    // program is initialized.
    // Debug Mode. DEBUGGING2 does not insertDebugMain, but prints allocation
    // diagnostics.
    ...
    // variables used by a macro (method newBlock) but could be shared by all
    ...
    // this goes after the main program, so that MEM_MANAGER_HEAP is after all other
