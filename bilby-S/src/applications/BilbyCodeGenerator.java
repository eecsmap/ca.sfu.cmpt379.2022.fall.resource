...
public class BilbyCodeGenerator extends BilbyApplication {
    /**
    ...
    private static void generateCodeIfNoErrors(String filename, ParseNode decoratedTree) throws FileNotFoundException {
    ...
    private static void generateAndPrintCode(String outfile, ParseNode decoratedTree) throws FileNotFoundException {
        ASMCodeFragment code = ASMCodeGenerator.generate(decoratedTree);
        printCodeToFile(outfile, code);
    }

    private static void printCodeToFile(String filename, ASMCodeFragment code) throws FileNotFoundException {
        File file = new File(filename);
